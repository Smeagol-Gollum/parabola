...
QT += testlib
TARGET = parabola-qt_test
DEFINES += PARABOLA_QT_TEST
...
contains(PARABOLA_NEED_QT_PLUGINS, 1) {
    DEFINES += PARABOLA_NEED_QT_PLUGINS
...
HEADERS += src/qt/parabolagui.h \
    ...
    src/qt/parabolaaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
...
SOURCES += src/qt/parabola.cpp \
    src/qt/parabolagui.cpp \
    ...
    src/qt/parabolaaddressvalidator.cpp \
    src/alert.cpp \
    src/chainparams.cpp \
    src/version.cpp \
    src/sync.cpp \
    ...
    src/qt/parabolastrings.cpp \
    src/qt/parabolaamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/parabola.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/parabola_*.ts)
...
win32:DEFINES += WIN32
win32:RC_FILE = src/qt/res/parabola-qt.rc
...
macx:ICON = src/qt/res/icons/parabola.icns
