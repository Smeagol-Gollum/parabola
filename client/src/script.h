...
#ifndef H_PARABOLA_SCRIPT
#define H_PARABOLA_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CParabolaAddress
 */
...
public:
    ...
    // Pre-version-0.6, Parabola always counted CHECKMULTISIGs
