...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("parabola.sipa.be", "seed.parabola.sipa.be"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.parabola.dashjr.org"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("parabola.petertodd.org", "testnet-seed.parabola.petertodd.org"));
